    ...
    override lazy val startJourneyRequest: StartJourneyRequestMibOrPngr = StartJourneyRequestMibOrPngr(
      ...
      payments = Seq[SjPaymentItem](
        SjPaymentItem(
          ...
          amount = amount,
          taxRegimeDisplay =
            "MODS", // https://github.com/hmrc/merchandise-in-baggage-frontend/blob/96027c5b4cdbc4f957c06b0c7e295861962f2432/app/uk/gov/hmrc/merchandiseinbaggage/model/api/tpspayments/TpsPaymentsItem.scala#L25
          taxType = taxType,
