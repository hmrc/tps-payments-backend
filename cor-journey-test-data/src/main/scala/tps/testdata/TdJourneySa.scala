...
trait TdJourneySa { dependencies: TdBase =>
  ...
  def tdJourneyInStatesSa = new TdJourneyInStates {
    ...
    override def amountString: String = "104.04"
    override def taxReference: String = "1234567895K"

    override def paymentSpecificData: SaSpecificData = SaSpecificData(
