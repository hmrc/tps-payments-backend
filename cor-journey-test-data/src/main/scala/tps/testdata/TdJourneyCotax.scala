...
trait TdJourneyCotax { dependencies: TdBase =>
  ...
  object TdJourneyCotax extends TdJourneyInStates {
    ...
    override final val selectedTaxType: TaxType = TaxTypes.CT
