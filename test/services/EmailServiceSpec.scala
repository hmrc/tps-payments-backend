...
class EmailServiceSpec extends ItSpec {
  ...
  "EmailService" - {
    ...
    val testTpsPaymentItem = TpsPaymentItem(Some(paymentItemId), 1.92, HeadOfDutyIndicators.B, LocalDateTime.parse("2020-01-20T11:56:46"), "JB", "12345", None, PaymentSpecificDataP800("JE231111", "B", "P800", 2000), P800, Some("test@email.com"))
